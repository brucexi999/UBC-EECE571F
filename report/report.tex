...
% \begin{table}[h!] \caption{Two benchmarks used for training and testing.}
%     \centering \begin{tabular}{|c c c|} \hline \hline & Benchmark A &
%     Benchmark B \\
%         \hline Length & 4 & 4 \\
%         Width & 4 & 4 \\
...
%         Edge capacity & 2 & 2 \\
%         \hline \hline \end{tabular} \label{tab:benchmark} \end{table} 
